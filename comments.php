<div id="comments">
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<span id="response" class="widget-title"><?php $this->commentsNum(_t('暂无评论'), _t('仅有 1 条评论'), _t('已有 %d 条评论')); ?></span>
    	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form">
			<div class="col1">
			<p>
                <textarea rows="8" cols="50" name="text" id="textarea"><?php $this->remember('text'); ?></textarea>
            </p>
			</div>
			<div class="col2">
